...
void FuzzyEureka::Start()
{
    ...
    auto& concurrency = GetConcurrency();
    auto& input = GetInput();
    ...
    // content.LoadSpriteSheet()

    
    // content.Load("Buildings/Wood/Keep");
    // content.LoadTexture("Animals/Boar");
    ...
    std::vector<Entity> entities;
    {
        ...
        engine.AddComponent(building, SpriteComponent{
            ...
            .texture = content.GetTexture("Buildings/Wood/Keep.png"),
            .sortLayer = 1,
        });
    ...
    //     boar.Cut(Sequence::Walk::Down, sf::Vector2i(0,0), sf::Vector2i(3,0));
    //     boar.Cut(Sequence::Walk::Up, sf::Vector2i(0,1), sf::Vector2i(3,1));
    //     boar.Cut(Sequence::Walk::Right, sf::Vector2i(0,2), sf::Vector2i(3,2));
    //     boar.Cut(Sequence::Walk::Left, sf::Vector2i(0,3), sf::Vector2i(3,3));
        
    //     engine.AddComponent(animal, AnimatorComponent{
    //         .animation = Sequence::Walk::Down,
    //         .spriteSheet = boar,
    //         .loop = true,
    //     });
